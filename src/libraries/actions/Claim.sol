...
library Claim {
    ...
    /// @param state The state
    /// @param params The input parameters for claiming a credit position
    //audit-ok @mody execute claim calls reduce credit --> validateminimumcredit. which makes sure the remiaining credit is always between 0 < credit < state.riskConfig.minimumCreditBorrowAToken
